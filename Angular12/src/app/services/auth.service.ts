...
LogTheCustomerOrBanker(customerNumber:string,isCustomer:string){
  this.setLogin(true);
  console.log("this.authService.logInOrOut is "+this.logInOrOut);
   localStorage.setItem('isLoggedIn', "true");
   localStorage.setItem('token', customerNumber+"");
...
public setLogin(newValue: boolean): void {
  ...
  addCustomer(customerNumber: any,passwd: any){
          var customer:ILogin = {userid: customerNumber,password:passwd,isLoggedIn:true,token:""};
