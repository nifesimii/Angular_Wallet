...
export class TransactionRestapiService {
  ...
  getTransactionsBy(accountNumber: string) : Observable<Transaction> {
  ...
  topup(topup: Transaction) : Observable<Transaction> {
  ...
  transfer(accountNumber: any) : Observable<Transaction> {
  ...
  withdraw(accountNumber: any) : Observable<Transaction> {
